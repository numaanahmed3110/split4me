  ...
  return (
    <svg viewBox="0 0 24 24" className={cn('size-[22px]', className)} fill="none" aria-hidden>
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <rect x="10.2" y="13.4" width="3.6" height="5.8" rx="0.8" fill="currentColor" />
    </svg>
  )
}
  ...
  return (
    <svg viewBox="0 0 24 24" className={cn('size-[22px]', className)} fill="none" aria-hidden>
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx="8" cy="12" r="3.2" fill="#FDECAD" stroke="currentColor" strokeWidth="1.4" />
      <circle cx="16" cy="12" r="3.2" fill="#E0F4F5" stroke="currentColor" strokeWidth="1.4" />
    </svg>
  )
}
  ...
  return (
    <svg viewBox="0 0 24 24" className={cn('size-[22px]', className)} fill="none" aria-hidden>
      <path
        ...
        strokeLinejoin="round"
      />
      <circle cx="16" cy="7.5" r="1.4" fill="#D8CEFA" stroke="currentColor" strokeWidth="0.8" />
    </svg>
  )
}
